...
if description.startswith("http"):
    ...
    print('Description')
print('<INPUT NAME=description size=80 value="' + html.escape(description, 1) + '">')
print("<br>")
print('Contact: <input name=contact size=30 value="' + html.escape(contact, 1) + '">')
print('Phone: <input name=phone size=15 value="' + html.escape(phone, 1) +'">')
print('Fax: <input name=fax size=15 value="' + html.escape(fax, 1) + '"><br>')
...
print('<input name=operator size=30 value="' + html.escape(operator, 1) + '"><br>')
print('Resources: '+resources+' [format: &lt;Associate code&gt;(&lt;hours&gt;), eg EI(50)]<hr>')
print("Notes<br>")
print("<center><TEXTAREA NAME=notes ROWS=12 COLS=80 WRAP=VIRTUAL>" + html.escape(notes) + "</TEXTAREA></center><br>")
print('Submitted by: <input name=submitter size=30 value="' + html.escape(submitter, 1) + '">')
if su(raddr()):
